...
public class PopularesActivity extends Activity implements NavigationDrawerFragment.NavigationDrawerCallbacks, MovieIFace {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        task.execute("sort_by=popularity.desc");
